...
class RadioScheduler():
    ...
    def run(self):
        ...
        if self.event_manager.contains_event_type(TimeEvent.EVENT_TYPE_CHECK_EXISTING_RADIOS) == False:
    ...
    def handle_event(self, event):
        ...
        elif event_type == TimeEvent.EVENT_TYPE_CHECK_EXISTING_RADIOS:
            self.handle_check_existing_radios(event)
        elif event_type == TimeEvent.EVENT_TYPE_CHECK_PROGRAMMING:
    ...
    def add_next_check_radios_event(self, seconds):
        ...
        #             'date': d
        #         }
        event = TimeEvent(TimeEvent.EVENT_TYPE_CHECK_EXISTING_RADIOS, d)
        self.event_manager.insert(event)
